    ...
    describe(`Given a valid user`, () => {
      ...
      it(`inserts 1 language with words for the new user`, () => {
        ...
        const expectedList = {
          ...
          total_score: 0,
          words: [
            { original: "програмист (programist)", translation: "programmer" },
            { original: "привет (privet)", translation: "hello" },
            { original: "пока (poka)", translation: "bye" },
            { original: "девелопер (developer)", translation: "developer" },
            { original: "молодец (molodets)", translation: "good job" },
            { original: "круто (kruto)", translation: "cool" },
            { original: "собака (sobaka)", translation: "dog" },
            { original: "кошка (koshka)", translation: "cat" },
          ],
        };
        return supertest(app)
          .post("/api/user")
